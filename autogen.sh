...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_kek to login script."
...
# the current dir:
if   test x${GTLANG_kek} = x ; then
	echo "WARNING: The variable \${GTLANG_kek} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_kek} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_kek} has the value:"
	echo "  ${GTLANG_kek}"
